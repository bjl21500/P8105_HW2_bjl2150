...
2. Every state is represented. There are total variables within the 'locationsabbr'
  column indicating that all  states are represented plus an additional state, 
