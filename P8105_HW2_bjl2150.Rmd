...
1. There are 404 unique locations included within this dataset.
  ...
  * 1B. Every state is represented. There are total variables within the 'locationsabbr'
...
2. `r median(brfss_spread_2$excellent, na.rm = TRUE)` is the median of the "Excellent"
...
brfss_scatter = select(brfss_spread, excellent, locationdesc, year) %>%
  spread(key = locationdesc, value = excellent) 

brfss_scatter_2 = select(brfss_scatter, "NY - Queens County", "NY - New York County")
