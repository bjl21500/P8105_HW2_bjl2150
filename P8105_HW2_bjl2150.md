...
The number of observations in the dataset trash\_wheel is 285, 14. The key variables in are dumpster, weight tons of trash, and plastic bottles collected. The number of variables in the precipitation dataset is 24, 3. The key variables in this particular data set are the months and years of precipiation as well as the toal amount of precipation 32.93
