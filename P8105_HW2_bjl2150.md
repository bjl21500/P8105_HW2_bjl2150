...
-   Question 1.1 There are 465 distinct stations.

-   Question 1.2 There are 84 stations that are ADA compliant.
...
## Combinging precip_16 and precip_17 datasets and conversion of month t 
...
-   Every state is represented. There are total variables within the 'locationsabbr' column indicating that all states are represented plus an additional state, which is Washington, D.C.
